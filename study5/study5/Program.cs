...
namespace study5
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ////부호없는 정수 데이터 형식
            //byte unsigendByte = 255;    //1바이트 크기
            //ushort unsignedShort = 65000;   //2바이트 크기
            //uint unsignedInt = 300000000;   //4바이트 크기

            //Console.WriteLine(unsigendByte);
            ...
            //decimal highPrecision = 3.1459256572682446213m; //고정밀도 (16바이트)
            ...
            //char number = '9';  //숫자 형태의 문자 저장(문자 '9',숫자 0 아님)
